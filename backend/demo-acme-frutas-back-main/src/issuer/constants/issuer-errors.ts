export const IssuerErrors = {
    ...
    E8091001: "Campaign with display name '%s', configuration id '%s' and issuer '%s' already exists.",
    ...
    E8091008: "Could not find any supported credential configuration for issuer '%s'.",
    E8091009: "Data source service returned an error when requesting to metadata. Response: '%s'.",
    E8091010: "Issuer '%s' could not process the configuration id '%s' with grant type '%s'.",
    E8091011: "Credential configuration id '%s' needs a pre-authorized_code in order to create a credential offer.",
    ...
    E8091023: "Credential configuration with did '%s' and credential configuration id '%s' already exists.",
    E8091024: "User does not have read permissions to this credential configuration.",
    ...
    E8091030: "Key with kid '%s' not found in did '%s'. Maybe you don't have read permissions over the key or DID does not contain the provided key.",
    E8091031: "Provided campaign-id '%s' is not associated with credential-identifier '%s'.",
    E8091032: "Provided campaign-id '%s' is not owned by issuer '%s'.",
    E8091033: "User does not have update permissions to this credential configuration.",
    E8091034: "There was a problem deleting resource with id '%s'.",
    E8091035: "User does not have delete permissions to this campaign.",
    E8091036: "User does not have delete permissions to this credential configuration.",
