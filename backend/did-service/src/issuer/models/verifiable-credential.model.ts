...
import { IsNotEmpty, IsString, ValidateNested, IsOptional, IsObject, IsArray, IsDateString } from 'class-validator';
import { instanceToPlain, Type } from 'class-transformer';
import { CredentialSchemaDto } from './credential-schema.model';
import { VerifiableCredential } from '@kaytrust/openid4vci';
