    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center mb-4">
              <LogoIcon />
              <span className="ml-2 text-xl font-bold text-white">Caserito</span>
            </div>
            <p className="text-gray-400 mb-4">
              Haciendo el comercio informal seguro, confiable y transparente para todos.
            </p>
        ...
        <div className="border-t border-gray-800 mt-10 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Caserito. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
