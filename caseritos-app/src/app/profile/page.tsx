...
import { Input, Textarea, Button, Toast, Card, StarRating } from "@/components/ui-components"
      ...
      <header className="bg-white border-b p-4">
        <div className="container max-w-3xl mx-auto">
          <div className="flex items-center justify-between">
            ...
            />
            <Button onClick={() => router.push(`/vendedor/${vendedorData.id}`)} variant="outline" className="text-sm">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button
                  variant="link"
                  onClick={() => router.push(`/vendedor/${vendedorData.id}/resenas`)}
                ...
                {reseñasRecientes.map((reseña) => (
                  <Card key={reseña.id} className="p-3">
                    <div className="flex items-center mb-2">
                      ...
                      <div>
                        <h3 className="text-sm font-medium">{reseña.comprador.nombre}</h3>
                        <div className="flex items-center">
                          <StarRating rating={reseña.rating} readOnly size={12} />
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-2xl font-bold">{vendedorData.calificacionPromedio.toFixed(1)}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Total de reseñas</p>
                  <p className="text-2xl font-bold">{vendedorData.totalReseñas}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Reseñas este mes</p>
