...
import { Button, Modal, Toast } from "@/components/ui-components"
import { ArrowLeft, Copy, CheckCircle, Calendar, ShoppingBag, Plus, Trash2 } from "lucide-react"
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <Card className="p-6">
                    ...
                    <div key={index} className="border rounded-md overflow-hidden relative">
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center mb-3">
                          ...
                          <span className="mx-2 text-sm text-muted-foreground">→ Subtotal:</span>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="flex gap-2 overflow-x-auto pb-2">
                            {producto.imagenes.map((img, imgIndex) => (
                              <div key={imgIndex} className="relative h-20 w-20 flex-shrink-0 group">
                                <Image
                ...
                <div className="mt-4 flex justify-end">
                  <Button className="bg-caserito-green hover:bg-caserito-green/90">Guardar cambios</Button>
                </div>
              </Card>
              ...
              {!venta.tieneResena && venta.estado !== "rechazada" && (
                <Card className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Comparte este enlace con tu cliente para que pueda confirmar la recepción y dejar su reseña.
                  </p>
                  <div className="flex items-center">
                    <div className="bg-gray-100 rounded-l-md p-3 flex-1 truncate text-sm">{venta.enlace}</div>
                    <Button onClick={copyLink} className="rounded-l-none" variant="default">
              ...
              <Card className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-sm">
                    ...
                    <span>Fecha: {format(venta.fecha, "d MMMM yyyy", { locale: es })}</span>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    Generar nueva venta
                    <span className="absolute right-3 text-xs opacity-70">→</span>
                  </Button>
                ...
                <div className="mt-4 pt-3 border-t">
                  <p className="text-xs text-muted-foreground text-center">
                    Al generar una nueva venta, se creará un enlace único para que el cliente pueda dejar su reseña y
                    subir imágenes.
                  </p>
                </div>
              </Card>
